...
(function(factory) {
  ...
  var Dialog = {
    ...
    show: function(opts) {
      ...
      var section = (typeof dialogConfig.section == 'string') ? $(dialogConfig.section) : dialogConfig.section;
      ...
      var left = Math.floor((windowWidth - outerWidth) / 2) + scrollLeft;
		  var top = Math.floor(outerHeight / 2);
      if (!dialogOpts.isFixed) {
        ...
        let margin_top = Math.floor(section.outerHeight() / 2);
        section.animate({
      ...
      section.off('DOMSubtreeModified.changed');
      section.on('DOMSubtreeModified.changed', function(){
        let margin_top = Math.floor($(this).innerHeight() / 2);
        section.animate({
          marginTop: -margin_top
        }, {
          queue: false
    ...
    install: function(opts) {
      ...
      var plugs_lightbox_section = '<div class="dialog-section' + (dialogOpts.escHide ? ' j_escHide' : '') + '" ' + markId + '>' + headerHtml + '<div class="dialog-body' + (dialogOpts.withNoPadding ? ' withNoPadding' : '') + (dialogOpts.noPadding ? ' noPadding' : '') + (dialogOpts.withNoMinWidth ? ' withNoMinWidth' : '') + '">' + content + '</div>' + closeHtml + '</div>';
  ...
  $.extend({
    ...
    sendConfirm: function(options) {
      ...
      if (isShowButton && options.hideButton !== true ) {
